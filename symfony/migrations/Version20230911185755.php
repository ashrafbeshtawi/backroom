 ...
 */
final class Version20230911185755 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE theme (id INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(1000) NOT NULL, permium BOOLEAN NOT NULL, PRIMARY KEY(id))');
